            ...
            $('#gridContainer').dxDataGrid({
                ...
                summary: {
                    ...
                    totalItems: [{
                        column: 'Subjects',
                        summaryType: 'sum',
                        displayFormat: 'Total Subject: {0}',
                    }, {
                        column: 'Male',
                        summaryType: 'sum',
                        displayFormat: 'Male: {0}',
                    }, {
                        column: 'Female',
                        summaryType: 'sum',
                        displayFormat: 'Female: {0}',
                    },]
                }
            });
        }
        ...
        success: function(result){
            $.each(result, function (k, val) {
                employee.push({
                    ...
                    "Total Male" : val.study_no.no_of_male_subjects,
                    "Total Female" : val.study_no.no_of_female_subjects,
                    "Study Type Name" : val.study_no.study_type.para_value,
            ...
            $('#postStudyGridContainer').dxDataGrid({
                ...
                columns: [{
                    ...
                    dataField: 'Total Male',
                }, {
                    dataField: 'Total Female',
                }, {
                    dataField: 'Study Type Name',
                    width: 100,
                }, {
                    dataField: 'Check In',
                    dataType: 'date',
                ...
                summary: {
                    ...
                    totalItems: [{
                        ...
                        column: 'Total Male',
                        summaryType: 'sum',
                        displayFormat: 'Total Male: {0}',
                    }, {
                        column: 'Total Female',
                        summaryType: 'sum',
                        displayFormat: 'Total Female: {0}',
                    },]
                }
            });
        }
