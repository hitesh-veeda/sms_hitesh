...
!(function (e, t) {
        ...
        return (
            ...
            e.isPrivate
                ...
                : (e.isReadOnly
                      ...
                      : e.recurrenceRule
                      ? n.push(
                            '<span class="calendar-font-icon ic-repeat-b"></span>'
                        )
                      : e.attendees.length
                      ? n.push(
                            '<span class="calendar-font-icon ic-user-b"></span>'
                        )
                      : e.location &&
                        n.push(
                            '<span class="calendar-font-icon ic-location-b"></span>'
                        ),
                  n.push(" " + e.title)),
            n.join("")
        );
    ...
    function p() {
        ...
        "day" === n
            ...
            : (a.push(
                  moment(l.getDateRangeStart().getTime()).format("YYYY.MM.DD")
              ),
              a.push(" ~ "),
