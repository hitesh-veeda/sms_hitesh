...
<div class="page-content">
    <div class="container-fluid">
        ...
        <form class="custom-validation" action="{{ route('admin.saveStudy') }}" method="post" id="addProject" enctype="multipart/form-data">
            @csrf
                                    ...
                                    <tbody >
                                        @if(!is_null($study->drugDetails))
                                            @foreach($study->drugDetails as $sk => $sv)
                                                <tr class="removeRow">
                                                    <td>
                                                        <select class="form-control select2 select_drug" name="drug[{{ $sk }}][drug]" id="drug_details" data-placeholder="Select Drug" required>
                                                    ...
                                                    <td>
                                                        <select class="form-control select2 select_dosage_form" name="drug[{{ $sk }}][dosage_form]" id="drug_details" data-placeholder="Select Dosage Form" required>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="drug[{{ $sk }}][dosage]" id="drug_details" placeholder="Dose" autocomplete="off" value="{{ $sv->dosage }}" required/>
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control" id="drug_details" name="drug[{{ $sk }}][drug_strength]" placeholder="Drug Strength" autocomplete="off" value="{{ $sv->drug_strength }}"/>
                                                    </td>
                                                    <td>
                                                        <select class="form-control select2 selectUOM" name="drug[{{ $sk }}][uom]" id="drug_details" data-placeholder="Select UOM" required>
                                                    ...
                                                    <td>
                                                        <select id="drug_details" class="form-control select2 selectType" name="drug[{{ $sk }}][type]" data-placeholder="Select Type" required>
                                                    ...
                                                    <td>
                                                        <input id="drug_details" type="text" class="form-control" name="drug[{{ $sk }}][manufacture]" id="manufacture" placeholder="Manufacture / Distribution By" autocomplete="off" value="{{ $sv->manufacturedby }}" required/>
                                                    </td>
                                                    <br>
                                                    <td>
                                                        <a href="javascript:void(0);" class="text-danger removeDrug" data-toggle="tooltip" data-id="{{ $sk }}"  data-placement="top" title="" data-original-title="Remove">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control select2 studyResult" id="study_result" name="study_result" data-placeholder="Select Study Result">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control numeric" name="no_of_groups" id="no_of_groups" placeholder="No Of Groups" autocomplete="off" value="{{ $study->no_of_groups }}" min="1" required/>
                            </div>

                            <div class="form-group mb-3">
                                <label>No Of Periods<span class="mandatory">*</span></label>
                                <input type="text" class="form-control numeric" name="no_of_periods" id="no_of_periods" placeholder="No Of Periods" autocomplete="off" value="{{ $study->no_of_periods }}" min="1" required/>
                            </div>
