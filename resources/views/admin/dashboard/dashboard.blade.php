                ...
                @if(Auth::guard('admin')->user()->role_id == 1 || Auth::guard('admin')->user()->role_id == 2 || Auth::guard('admin')->user()->role_id == 3 || Auth::guard('admin')->user()->role_id == 4 || Auth::guard('admin')->user()->role_id == 5 || Auth::guard('admin')->user()->role_id == 6 || Auth::guard('admin')->user()->role_id == 10 || Auth::guard('admin')->user()->role_id == 14)
                    <div style="border: 2px solid;">
                        ...
                        <div class="col-xl-12">
                            <div class="row">
                                <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?refStatus=COMPLETED" title="Completed">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                ...
                                <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?refStatus=ONGOING" title="Ongoing">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                ...
                                <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?refStatus=UPCOMING" title="Upcoming">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                ...
                                <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?refStatus=DELAY" title="Delay">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                    ...
                    <div style="border: 2px solid;">
                        ...
                        <div class="col-xl-12">
                            <div class="row">
                                <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?ref=COMPLETED" title="Completed">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                ...
                                <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?ref=ONGOING" title="Ongoing">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                ...
                                <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?ref=UPCOMING" title="Upcoming">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                ...
                                <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?ref=DELAY" title="Delay">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                ...
                @elseif(Auth::guard('admin')->user()->role_id == 11 || Auth::guard('admin')->user()->role_id == 12)
                    ...
                    <div style="border: 2px solid;">
                        ...
                        <div class="col-xl-12">
                            <div class="row">
                                <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?ref=COMPLETED&crLocationName={{base64_encode(Auth::guard('admin')->user()->location_id)}}" title="Completed">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                ...
                                <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?ref=ONGOING&crLocationName={{base64_encode(Auth::guard('admin')->user()->location_id)}}" title="Started on time, but not completed"   >
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                               ...
                               <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?ref=UPCOMING&crLocationName={{base64_encode(Auth::guard('admin')->user()->location_id)}}" title="Upcoming">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                               ...
                               <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?ref=DELAY&crLocationName={{base64_encode(Auth::guard('admin')->user()->location_id)}}" title="Not started as per scheduled start date">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                ...
                @elseif(Auth::guard('admin')->user()->role_id == 13 || Auth::guard('admin')->user()->role_id == 15)
                    ...
                    <div style="border: 2px solid;">
                        ...
                        <div class="col-xl-12">
                            <div class="row">
                                <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?ref=COMPLETED&brLocationName={{base64_encode(Auth::guard('admin')->user()->location_id)}}" title="Started on time, completed on time">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                ...
                                <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?ref=ONGOING&brLocationName={{base64_encode(Auth::guard('admin')->user()->location_id)}}" title="Started on time, but not completed"   >
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                ...
                                <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?ref=UPCOMING&brLocationName={{base64_encode(Auth::guard('admin')->user()->location_id)}}" title="Upcoming">
                                       <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                ...
                                <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?ref=DELAY&brLocationName={{base64_encode(Auth::guard('admin')->user()->location_id)}}" title="Not started as per scheduled start date">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                ...
                @else
                    <div style="border: 2px solid;">
                        ...
                        <div class="col-xl-12">
                            <div class="row">
                                <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?ref=COMPLETED" title="Started on time, completed on time">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                ...
                                <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?ref=ONGOING" title="Started on time, but not completed"   >
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                ...
                                <div class="col-md-3">
                                    <a href="{{ route('admin.studyActivityMonitoringList') }}?ref=DELAY" title="Not started as per scheduled start date">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
